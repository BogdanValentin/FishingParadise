...
public class ModFoodComponents {
    ...
    public static final FoodComponent RAW_HERING = new FoodComponent.Builder().hunger(2).saturationModifier(0.2f).meat().build();
    public static final FoodComponent COOKED_HERING = new FoodComponent.Builder().hunger(6).saturationModifier(0.5f).meat().build();
